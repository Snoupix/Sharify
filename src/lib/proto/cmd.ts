...
export const HttpCommand: MessageFns<HttpCommand> = {
	...
	fromPartial<I extends Exact<DeepPartial<HttpCommand>, I>>(object: I): HttpCommand {
		const message = createBaseHttpCommand();
		message.createRoom =
			object.createRoom !== undefined && object.createRoom !== null
				? HttpCommand_CreateRoom.fromPartial(object.createRoom)
				: undefined;
		message.getRoom =
			object.getRoom !== undefined && object.getRoom !== null
				? HttpCommand_GetRoom.fromPartial(object.getRoom)
				: undefined;
		message.joinRoom =
			object.joinRoom !== undefined && object.joinRoom !== null
...
export const Command: MessageFns<Command> = {
	encode(message: Command, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
		...
		if (message.deleteRole !== undefined) {
			writer.uint32(122).bytes(message.deleteRole);
		}
		return writer;
	},
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 15: {
					...
					message.deleteRole = reader.bytes();
					continue;
				}
			}
			if ((tag & 7) === 4 || tag === 0) {
	...
	fromJSON(object: any): Command {
		return {
			...
			deleteRole: isSet(object.deleteRole) ? bytesFromBase64(object.deleteRole) : undefined,
		};
	},
	...
	toJSON(message: Command): unknown {
		...
		if (message.deleteRole !== undefined) {
			obj.deleteRole = base64FromBytes(message.deleteRole);
		}
		return obj;
	},
	...
	fromPartial<I extends Exact<DeepPartial<Command>, I>>(object: I): Command {
		...
		message.addToQueue =
			object.addToQueue !== undefined && object.addToQueue !== null
		...
		message.kick =
			object.kick !== undefined && object.kick !== null ? Command_Kick.fromPartial(object.kick) : undefined;
		...
		message.createRole =
			object.createRole !== undefined && object.createRole !== null
				? Command_CreateRole.fromPartial(object.createRole)
				: undefined;
		message.renameRole =
			object.renameRole !== undefined && object.renameRole !== null
				? Command_RenameRole.fromPartial(object.renameRole)
				: undefined;
		message.deleteRole = object.deleteRole ?? undefined;
		return message;
	},
};
	...
	fromJSON(object: any): CommandResponse {
		return {
			...
			spotifySearchResult: isSet(object.spotifySearchResult)
				...
				: undefined,
			spotifyRateLimited: isSet(object.spotifyRateLimited)
				? globalThis.Number(object.spotifyRateLimited)
				: undefined,
	...
	fromPartial<I extends Exact<DeepPartial<CommandResponse>, I>>(object: I): CommandResponse {
		...
		message.kick =
			object.kick !== undefined && object.kick !== null
				...
				: undefined;
		message.ban =
			object.ban !== undefined && object.ban !== null ? CommandResponse_Ban.fromPartial(object.ban) : undefined;
		message.spotifyAllState =
			object.spotifyAllState !== undefined && object.spotifyAllState !== null
				? CommandResponse_SpotifyAllState.fromPartial(object.spotifyAllState)
				: undefined;
		message.spotifySearchResult =
			object.spotifySearchResult !== undefined && object.spotifySearchResult !== null
		...
		message.spotifyPlaybackState =
			object.spotifyPlaybackState !== undefined && object.spotifyPlaybackState !== null
				? CommandResponse_SpotifyPlaybackState.fromPartial(object.spotifyPlaybackState)
				: undefined;
		message.spotifyTracksState =
			object.spotifyTracksState !== undefined && object.spotifyTracksState !== null
...
export const CommandResponse_SpotifyAllState: MessageFns<CommandResponse_SpotifyAllState> = {
	...
	create<I extends Exact<DeepPartial<CommandResponse_SpotifyAllState>, I>>(
		base?: I,
	...
	fromPartial<I extends Exact<DeepPartial<CommandResponse_SpotifyAllState>, I>>(
		...
		const message = createBaseCommandResponse_SpotifyAllState();
		message.state =
			object.state !== undefined && object.state !== null ? PlaybackState.fromPartial(object.state) : undefined;
		message.previousTracks =
			object.previousTracks !== undefined && object.previousTracks !== null
				? TrackArray.fromPartial(object.previousTracks)
				: undefined;
		message.nextTracks =
			object.nextTracks !== undefined && object.nextTracks !== null
